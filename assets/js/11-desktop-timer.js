...
(function () {
    ...
    function applyRemoteTimerState(remoteProfile) {
        ...
        const remoteStart = remoteProfile?.active_timer_start ? Number(remoteProfile.active_timer_start) : null;
    ...
    function stopTimerSync() {
        if (timerSyncHandle) clearInterval(timerSyncHandle);
        timerSyncHandle = null;
        if (timerChannel && client) client.removeChannel(timerChannel);
        timerChannel = null;
    }
