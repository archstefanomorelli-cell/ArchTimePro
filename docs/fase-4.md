...
- Il percorso parametrico mostra le prestazioni organizzate nelle sei macrofasi operative.
...
- La futura pagina pubblica di calcolo potrà salvare il calcolo completo in `normative_data` e usare lo stesso flusso di importazione.
