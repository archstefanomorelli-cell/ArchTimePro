...
(function () {
    ...
    function friendlyAccessError(error) {
        ...
        if (message.includes('SUBSCRIPTION_REQUIRED')) {
            return 'La prova o l’abbonamento non sono attivi. Apri archtimepro.it per gestire il piano o esportare i dati.';
        }
        if (message.includes('LEGAL_ACCEPTANCE_REQUIRED')) {
            return 'Apri una volta Arch Time Pro sul web per leggere e accettare i documenti aggiornati.';
        }
        return message;
    }
